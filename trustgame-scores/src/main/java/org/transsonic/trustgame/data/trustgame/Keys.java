...
public class Keys {
    ...
    public static final ForeignKey<GameplayRecord, UsergroupRecord> FK_GAMEPLAY_USERGROUP1 = Internal.createForeignKey(Gameplay.GAMEPLAY, DSL.name("fk_GamePlay_UserGroup1"), new TableField[] { Gameplay.GAMEPLAY.AUTOREGISTERUSERGROUP_ID }, Keys.KEY_USERGROUP_PRIMARY, new TableField[] { Usergroup.USERGROUP.ID }, true);
